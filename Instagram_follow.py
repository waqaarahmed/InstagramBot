...
class InstaBot:
    ...
    def bulk_follow(self):
        self.driver.find_element(By.XPATH, '//*[@id="react-root"]/section/main/div/header/section/ul/li[3]/a')\
            .send_keys(Keys.ENTER)
        sleep(3)
        scroll_box = self.driver.find_element_by_css_selector("div[class='isgrP']")
        #Add the number of following of the user
        scrolling_times = (numberoffollowing / 4)
        scroll = 0
